<template>
    <div class="tags-nav">
        <div class="close-con">
            <Dropdown transfer @on-click="handleTagsOption" style="width: 20px;height: 28px;">
                <Button size="small" type="text">
                    <Icon :size="16" type="ios-close-circle-outline" style="font-weight: bold;" />
                </Button>
        ...
        >
            ...
            <li @click="handleTagsOption('all')">{{ $t("portal.closeAll") }}</li>
            <li @click="handleTagsOption('others')">{{ $t("portal.closeOther") }}</li>
        </ul>
        ...
        <div class="btn-con reload-btn">
            <Button type="text" @click="reload">
                <CommonIcon type="_shuaxin" :size="12" />
            </Button>
        </div>
        <div
            class="scroll-outer"
        ...
        >
            <div ref="scrollBody" class="scroll-body" :style="{ left: tagBodyLeft + 'px' }">
                <transition-group name="taglist-moving-animation" v-if="$i18n&&list.length">
                    <Tag
                        type="dot"
                    ...
                    >
                        ...
                        ? item.meta.title || $t(item.name)
                        : item.meta.enTitle || $t(item.name)
                        }}
                    </Tag>
                </transition-group>
            </div>
