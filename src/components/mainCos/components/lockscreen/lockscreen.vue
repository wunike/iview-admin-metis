<template>
    <div @click="lockScreen" class="lock-screen-btn-con" style="margin-right: 12px;">
        <Tooltip content="锁屏" placement="bottom">
      		<CommonIcon type="_suo" :size="16" :style="{marginTop: '-0px',display:'inline-block', verticalAlign: 'middle'}"/>
        </Tooltip>
    </div>
</template>
