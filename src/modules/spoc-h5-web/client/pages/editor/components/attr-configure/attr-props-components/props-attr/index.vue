<template>
    <div v-if="currentElementProps.length">
        <div class="page-title marginB10 fontBold">组件属性</div>
        <el-form><component v-for="item in currentElementProps" :key="item" :is="'attr-qk-' + item" v-bind.sync="activeElement.propsValue" /></el-form>
    </div>
</template>
