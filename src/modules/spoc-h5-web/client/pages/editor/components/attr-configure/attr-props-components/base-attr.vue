        ...
        <el-collapse v-model="activeNames">
            <el-collapse-item title="尺寸与位置：" name="1">
                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" v-model="activeElement.commonStyle.height" controls-position="right" :min="0" />
            ...
            <el-collapse-item title="边框边距：" name="2">
                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" v-model="activeElement.commonStyle.borderWidth" @change="throttleAddHistory" controls-position="right" :min="0" />
                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.borderRadius" controls-position="right" :min="0" />
                    </div>
                </div>
                <!--边距-->
                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.paddingTop" controls-position="right" :min="0" />
                    </div>
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.paddingBottom" controls-position="right" :min="0" />
                    </div>
                </div>
                <div class="attr-item-edit-wrapper">
                    <p class="attr-item-title">左右边距：</p>
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.paddingLeft" controls-position="right" :min="0" />
                    </div>
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.paddingRight" controls-position="right" :min="0" />
                    </div>
                </div>
                <!--外边距-->
            </el-collapse-item>
            <el-collapse-item title="阴影样式：" name="3">
                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="boxShadowChange" v-model="boxShadow.spread" controls-position="right" />
                        <div class="attr-item-edit-input-des">垂直阴影位置</div>
                    </div>
                </div>
                <div class="attr-item-edit-wrapper">
                    <p class="attr-item-title">阴影颜色：</p>
                    <div class="attr-item-edit-input"><el-color-picker size="mini" @change="boxShadowChange" v-model="boxShadow.color"></el-color-picker></div>
                </div>
            </el-collapse-item>
            <el-collapse-item title="字体：" name="4">
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.fontSize" controls-position="right" :min="0" />
                    </div>
                </div>
                <div class="attr-item-edit-wrapper">
                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.lineHeight" controls-position="right" :min="0" :step="0.1" />
                    </div>
                </div>
                <div class="attr-item-edit-wrapper">
                    <p class="attr-item-title">字间距：</p>
                    <div class="col-2 attr-item-edit-input">
                        <el-input-number size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.letterSpacing" controls-position="right" :min="0" />
                    </div>
                </div>
                <div class="attr-item-edit-wrapper">
                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="attr-item-edit-input"><el-color-picker size="mini" @change="throttleAddHistory" v-model="activeElement.commonStyle.color"></el-color-picker></div>
                </div>
            </el-collapse-item>
            <el-collapse-item title="背景&&透明度：" name="5">
                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="attr-item-edit-input"><imageSelect :url.sync="activeElement.commonStyle.backgroundImage" @change="throttleAddHistory" /></div>
                </div>
