<!--test.vue-->
<template>
    <div class="qk-ve-bar"><ve-bar :data="chartData" width="100%" height="100%" :settings="chartSettings" ref="veChart"></ve-bar></div>
</template>

<script>
export default {
    name: 'QkVeBar', // 这个名字很重要，它就是未来的标签名<qk-text></qk-text>
    props: {
        chartData: {
            type: Object,
            default: () => {
