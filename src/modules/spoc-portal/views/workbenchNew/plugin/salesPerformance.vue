...
.sales-performance-plugin-wrapper {
...
<template lang="html">
<plugin-template class="sales-performance-plugin-wrapper" 
    ...
    @init="init">
    <!-- start -->
    <saleCharts :menuRoute="data.menuRoute"></saleCharts>
    <!-- end -->
</plugin-template>
</template>
...
import saleCharts from '../../../../spoc-sign-web/src/views/saleCharts/saleCharts.vue'
export default {
    components: {
        pluginTemplate,
        saleCharts
