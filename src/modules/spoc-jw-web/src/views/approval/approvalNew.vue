...
export default {
	...
	data() {
		return {
			...
			tableTitle: this.$t('modules_spoc_jw_web_src_views_approval_approvalnew_2250'),
								...
								h(
                                    ...
                                    (this.tabValue == 'C'
                                        ...
                                        :(params.row.status == 'reject' || params.row.status == 'uncommit')
                                            ...
                                            :parseInt(parseInt(params.row.curNodeOrder)+1)) + '/' + parseInt(parseInt(params.row.flowLevel)+1)
								),
								h(
									"span",
									{
