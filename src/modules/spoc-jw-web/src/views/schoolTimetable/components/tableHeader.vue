...
export default {
	...
	filters: {
		week: function(val) {
			if (val === 1) return '周一';//this.$t('modules_spoc_crm_web_src_views_customer360_components_timetable_tableheader_1053');
			else if (val === 2) return '周二'; //this.$t('modules_spoc_crm_web_src_views_customer360_components_timetable_tableheader_1054');
			else if (val === 3) return '周三'; // this.$t('modules_spoc_crm_web_src_views_customer360_components_timetable_tableheader_1055');
			else if (val === 4) return '周四'; // this.$t('modules_spoc_crm_web_src_views_customer360_components_timetable_tableheader_1056');
			else if (val === 5) return '周五'; // this.$t('modules_spoc_crm_web_src_views_customer360_components_timetable_tableheader_1057');
			else if (val === 6) return '周六'; // this.$t('modules_spoc_crm_web_src_views_customer360_components_timetable_tableheader_1058');
			else return '周日'; //this.$t('modules_spoc_crm_web_src_views_customer360_components_timetable_tableheader_1059');
		}
	},
	watch: {
		classRoomName(val) {
