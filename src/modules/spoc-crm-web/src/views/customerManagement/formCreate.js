                        ...
                        if (res.ok) {
                            ...
                            list.forEach((v, k) => {
                                ...
                                if (v.jdbcType == 'AddressMap') {
                                    obj = JSON.parse(JSON.stringify(this.formMap.input));
                                } else {
                                    obj = JSON.parse(JSON.stringify(this.formMap[v.jdbcType]));
                                }
                                obj.title = '';
                                obj.props.placeholder = v.name;
                                obj.field = v.field;
                                obj.options = v.filtersKey ? dictTypeObj[v.filtersKey] : (v
                                    .filterList || []);
                                obj.validate = [];
