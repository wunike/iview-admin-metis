...
// export const baseURLSys = '/spoc-contract/a/ws/sys';
...
import {
    getProps
} from '@public/libs/props';
export const sysProps = getProps(httpSys);

import {
    getSysConfig
} from '@public/libs/sysConfig';
