...
import valid, { errors, jxLesson } from "../../libs/request";
export default {
	name: "hootie.importCourse",
	data() {
		return {
			templateLists: {
				curr: jxLesson.importXb, // 导入数据EXCEL  (一个地址)
				reportUrl: jxLesson.downReportXb, // 下载导入错误报告EXCEL (一个地址)
				download: jxLesson.templateXb, // 下载EXCEL导入模板 (一个地址)
