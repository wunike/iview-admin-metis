...
<template>
    <div class="massQuillEditor">
        ...
        <div class="type-img" @click="showImgBox">
            <Icon type="ios-image" />
            <span>{{$t('modules_spoc_hootie_web_src_views_message_massmeditor_2046', [ imgnum ])}}</span>
            <up-img-new
                ...
                class="abs-img"
                fileInputId="massQuillEditorUpImg"
        ...
        <div class="type-img" @click="showVideoBox">
            <Icon type="md-film" />
            <span>{{$t('modules_spoc_hootie_web_src_views_message_massmeditor_2047', [ videonum ])}}</span>
            <up-video-new
                ref="upVideoNew"
                ...
                class="abs-file"
                fileInputId="massQuillEditorUpVideo"
                :objectType="objectType"
                :objectId="objectId"
                :kind="kind"
                :maxNum="3"
        ...
        <div class="type-img" @click="showFileBox">
            ...
            <span>{{$t('modules_spoc_hootie_web_src_views_message_massmeditor_2048', [ filenum ])}}</span>
            <up-file-new
                ref="upFileNew"
                ...
                class="abs-file"
                fileInputId="massQuillEditorUpFile"
                :objectType="objectType"
                :objectId="objectId"
                :kind="kind"
                :maxNum="3"
        ...
        <quill-editor
            ...
            id="masseditor-container"
        >
            <div id="masstoolbar" slot="toolbar"><button class="ql-emoji"></button></div>
        </quill-editor>
