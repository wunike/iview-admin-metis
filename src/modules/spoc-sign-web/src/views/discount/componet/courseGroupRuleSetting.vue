...
<template>
    <div class="courseGroupRuleSetting">
        ...
        <div class="chooseCourse">
            <div class="forChoose">
                <div class="title">{{$t('modules_spoc_sign_web_src_views_discount_componet_coursegrouprulesetting_6130', [courseForChoose.length])}}</div>
                <div class="search">
            ...
            <div class="hasChoosed">
                <div class="title">{{$t('modules_spoc_sign_web_src_views_discount_componet_coursegrouprulesetting_6132', [courseHasChoosed.length])}}</div>
        ...
        <div>
            ...
            <div class="courseGroupRuleSettingTable">
                <div class="table-div">
