...
<template>
	<div class="v_sign_discount_add_item">
		<Form ref="disform" :label-width="135" :model="formData" :rules="rule">
			<FormItem :label="$t('modules_spoc_sign_web_src_views_discount_componet_vadddiscountitem_bak_6188')" prop="name">
			...
			<FormItem :label="$t('modules_spoc_sign_web_src_views_discount_componet_vadddiscountitem_bak_6194')">
				...
				<div class="table-content">
					<div class="table-header">
						<ul>
							...
							<li class="table-li">{{$t('views_coursepack_coursepack_379')}}</li>
							<li class="table-li">{{$t('modules_spoc_sign_web_src_views_discount_componet_vadddiscountitem_6177')}}</li>
							<li class="table-li">{{$t('views_coursepack_coursepackgroup_453')}}</li>
					...
					<div class="table-footer">
						<div class="table-item" v-for="(item, index) in formData.htItemSubList" :key="item.name + index">
							<ul>
								...
								<li class="table-li">
									<Input v-model="item.num" v-if="item.tableEdit" />
								...
								<li class="table-li">
									<Input v-model="item.publicPrice" v-if="item.tableEdit" />
		...
		data() {
			...
			return {
				...
				rule: {
					...
					type: [{
						required: true,
						message: this.$t('modules_spoc_sign_web_src_views_discount_componet_vadddiscountitem_bak_6218'),
						trigger: 'change'
					}],
					protocalType: [
