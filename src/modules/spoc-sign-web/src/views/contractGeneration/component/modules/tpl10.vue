...
//					v = replace(text, ['$1$', this.data.name], ['$2$', name], ['$3$', num], ['$4$', Number(publicPrice||0).toFixed(2)], ['$5$', ratio/100], ['$6$', Number(costPrice||0).toFixed(2)]);
					v = replace(text, ['$1$', this.data.name], ['$2$', name], ['$3$', (item.htItemSettingMap.ServeLimit||'-')+'-'+(item.htItemSettingMap.ServeLimitEnd||'-')], ['$4$', Number(publicPrice||0).toFixed(2)],['$5$', ratio/100], ['$6$', Number(costPrice||0).toFixed(2)]);
